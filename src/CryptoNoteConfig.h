...
const uint64_t CRYPTONOTE_BLOCK_WALLETP_FEE 	 	     = 5;
const uint64_t CRYPTONOTE_BLOCK_DEV_FEE			     = 5;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 8;
const uint32_t UPGRADE_HEIGHT_V5                             = 13;
const uint32_t UPGRADE_HEIGHT_V6			     = 20;
